...
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := $(BOARD_OPENSOURCE_DIR)/core-utils/vendor_framework_compatibility_matrix.xml
...
ifneq ($(filter $(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX),$(VULKAN_FEATURE_LEVEL_0_TARGETS_LIST)),)
PRODUCT_COPY_FILES += \
